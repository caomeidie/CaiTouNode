 ...
 * */
 var netConfig = {
	...
	/***** URI SETTING START *****/
	/**
	 * Set if the uri path is normal format or pathinfo format.
	 * If false the uri path format must be like 'http://hostname?m=home&c=index&a=index'.
	 * If true the uri path format must be like 'http://hostname/home/index/index'.
	 * The default value of pathInfo is true.
	 */
	pathInfo : true
	/***** URI SETTING END *****/
};
